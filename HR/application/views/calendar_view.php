                    ...
                    <div class="row" style="padding: 0 10px 0 0;">
                        ...
                        <div class="col-md-10" style="margin-left:0px; padding-left:0px;">
                            ...
                            <div class='bio-value bio-value-datepicker'>
                                <input class="form-control" type="text" name=<?php print htmlentities("Start" . $vacationCounter) ?> value='<?php print htmlentities(($vacation->StartDate)) ?>'>
                            </div>
                            <div class="bio-description">End</div>
                            <div class='bio-value bio-value-datepicker'>
                                <input class="input-daterange" type="text" name=<?php print htmlentities("End" . $vacationCounter) ?> value='<?php print htmlentities(($vacation->EndDate)) ?>'>
                            </div>
                            ...
                            <div class="input-daterange input-group" id="datepicker">
                                <div class="bio-description">Start</div>
                                <div class="bio-value"> <input type="text" class="input-sm form-control" name="start" />
                                </div>
                                <div class="bio-description">End</div>
                                <div class="bio-value">
